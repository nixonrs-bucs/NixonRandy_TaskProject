...
namespace NixonRandy_TaskProject.Controllers
{
    public class DashBoardController : Controller
    {
        ...
        public async Task<IActionResult> Create(NixonRandy_TaskProject.Models.Entities.Project project)
        {
        ...
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, NixonRandy_TaskProject.Models.Entities.Project EditedProject)
        {
            if (ModelState.IsValid)
            {
